:: Run Gauntlet of Meta Devices, by disabling features that could intefere with the test
:: For more info, please refer to the following repo: https://github.com/S1Lazza/GauntletAutomationDemo/tree/UE-5.2
